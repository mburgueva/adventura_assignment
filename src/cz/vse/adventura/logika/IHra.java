...
{
    //== VEŘEJNÉ KONSTANTY public constants=====================================================
    //== DEKLAROVANÉ METODY declared methods ====================================================
    /**
     ...
     *  @return  vrací se řetězec, který se má vypsat na obrazovku
     */
    public String vratEpilog(); //returnEpilog
     ...
     */
     public boolean konecHry(); //endOfGame
     ...
     */
     public HerniPlan getHerniPlan(); //gamePlan
    
    //== ZDĚDĚNÉ METODY Inheritant methods========================================================
    //== INTERNÍ DATOVÉ TYPY ===================================================
}
